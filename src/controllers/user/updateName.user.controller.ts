...
import updateNameService from "../../services/user/updateName.service";
...
const updateName = asyncHandler(async (req: Request<{}, {}>, res: Response) => {
     ...
     */
    const updatedUser = await updateNameService(walletAddress, name);
     ...
     */
    httpResponse(req, res, 200, responseMessage.UPDATED_SUCCESSFULLY("User Name"), updatedUser);
});
